...
/**
 * need to add specifique listener for safari case in order to resize popup in real time
 */
window.addEventListener("load", function()
{
	...
	var updateSize = function()	{
		if (needResize && !resizingScheduled) {
			setTimeout(function() {
...
/**
 * add event listener to notify when content is loaded in order to remove paypal content (action not working on Safari)
 */
